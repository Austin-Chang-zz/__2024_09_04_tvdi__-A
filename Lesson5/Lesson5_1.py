...
class Window(ThemedTk):
    def __init__(self,*args, **kwargs):
        ...
        #========== row=2
        # radioFrame =ttk.Frame(bottomFrame).grid(column=0,row=2,columnspan=2)
        # sizes = (('Small', 'S'),
        #  ('Medium', 'M'),
        #  ('Large', 'L'),
        #  ('Extra Large', 'XL'),
        #  ('Extra Extra Large', 'XXL'))
        # lebel = ttk.Label(radioFrame,text="what is your t-shirt size ?").pack()
    ...
    def ok_click(self):
        ...
        showinfo(title="use input",message=f'user nmae: {username}\n user password: {password}')
