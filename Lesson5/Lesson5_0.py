...
class Window(ThemedTk):
    def __init__(self,*args,**kwargs):
        ...
        btn3 = ttk.Button(topFrame,text="亞洲",command=self.user_click3)
    ...
    def user_click2(self):   # instance method
        print("hello:button2")
    def user_click3(self):   # instance method
        print("hello:button3")

def main():   # def main is a function
